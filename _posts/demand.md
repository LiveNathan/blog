...
![asymptote.png](../assets/images/asymptote.png)
...
Common business advice is to talk to customers. Discover their problem then and build the solution.
...
I had to talk it out of its own ideas: *"But only one person actually asked for that."*
*"Oh yeah, you're right,"* it would reply.
